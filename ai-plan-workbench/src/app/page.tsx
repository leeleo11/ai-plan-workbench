...
export default function Home() {
  ...
  return (
    <main className="min-h-screen overflow-hidden px-4 py-6 md:px-8">
      <div className="pointer-events-none fixed -right-12 top-12 h-36 w-36 rotate-12 rounded-lg border-2 border-[var(--line)] bg-[var(--peach)] opacity-50 shadow-[5px_5px_0_var(--line)] animate-float-gentle" />
      <div className="pointer-events-none fixed bottom-10 left-8 h-24 w-24 -rotate-6 rounded-full border-2 border-[var(--line)] bg-[var(--mint)] opacity-50 shadow-[4px_4px_0_var(--line)] animate-breathe" />
